...
function DashBoard() {
    ...
    return <div style={{ padding: "10px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div style={{ width: "76px", height: "76px", borderRadius: "100%", backgroundColor: "#4566EC" }}>
                <img
                    src={AddIcon}
                    alt="Right Image"
                    onClick={() => { SetisAddNewTaskOpen(true) }}
                    style={{ position: "relative", left: "50%", top: "50%", width: "19px", height: "19px", transform: "translate(-50%,-50%)" }}
                />
            </div>
        </div>
        <AddTask isOpen={isAddNewTaskOpen} onClose={() => SetisAddNewTaskOpen(false)} />
    </div>
